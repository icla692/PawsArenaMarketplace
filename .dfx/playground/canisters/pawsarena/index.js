...
import { idlFactory } from './pawsarena.did.js';
export { idlFactory } from './pawsarena.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PAWSARENA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pawsarena.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pawsarena canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pawsarena.did.js")._SERVICE>}
 */
export const pawsarena = createActor(canisterId);
